...
const getFeedsABP = async() => {
    try{
        const responseABPGuj = await axios.get('https://gujarati.abplive.com/sports/feed');
...
const getFeedsGujaratSamachar = async() => {
    try{
        ...
        const responseGujaratSamachar = await axios.get('https://www.gujaratsamachar.com/rss/category/sports');
...
const getFeedsSandesh = async() => {
    try{
        ...
        const responseSandesh = await axios.get('https://sandesh.com/rss/sports.xml');
...
export const getGujratiSportsFeeds = async(req,res) => {
    try{
