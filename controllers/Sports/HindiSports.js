...
const getFeedsABP = async() =>{
    try{
        const responseABP = await axios.get('https://www.abplive.com/sports/feed');
...
const getFeedsIndiaTV = async() =>{
    try{
        const responseIndiaTv = await axios.get('https://www.indiatv.in/rssnews/topstory-sports.xml')
...
const getFeedsNews18 = async() =>{
    try{
        ...
        const responseNews18 = await axios.get('https://hindi.news18.com/rss/khabar/sports/others.xml');
...
export const getHindiSportsFeeds = async(req,res) => {
