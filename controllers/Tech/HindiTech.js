...
const getFeedsABP = async() => {
    try{
        ...
        const responseABP = await axios.get('https://www.abplive.com/technology/feed');
...
const getFeedsNew18 = async() => {
    try{
        
        const responseNews18 = await axios.get('https://hindi.news18.com/rss/khabar/entertainment/tech.xml');
...
const getFeedsIndiaTv = async() => {
    try{
        const responseIndiaTv = await axios.get('https://www.indiatv.in/rssnews/topstory-tech.xml')
...
export const getHindiTechFeeds = async(req,res) => {
    try{
        const feedsABP = await getFeedsABP();
        const feedsNews18  = await getFeedsNew18();
