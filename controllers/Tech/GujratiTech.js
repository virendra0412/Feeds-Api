...
const getFeedsABP = async() => {
    try{
        const responseABPGuj = await axios.get('https://gujarati.abplive.com/technology/feed');
...
const getFeedsGujaratSamachar = async() => {
    try{
        const responseGujaratSamachar = await axios.get('https://www.gujaratsamachar.com/rss/category/science-technology');
...
const getFeedsSandesh = async() => {
    try{
        const responseSandesh = await axios.get('https://sandesh.com/rss/tech.xml');
...
export const getGujratiTechFeeds = async(req,res) => {
    try{
        
        const feedsABP = await getFeedsABP();   
        const feedSandesh = await getFeedsSandesh()
        const feedsGujaratSamachar = await getFeedsGujaratSamachar()
        
        const allFeeds = [];

        allFeeds.push(feedsABP)
        allFeeds.push(feedSandesh)
        allFeeds.push(feedsGujaratSamachar)
